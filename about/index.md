...
Isla Staden was a Research Assistant in the Whitaker Lab, refactoring [Brain Networks In Python](https://github.com/WhitakerLab/BrainNetworksInPython) into [scona](https://github.com/WhitakerLab/scona)🍪 and curating data in the [Neuroscience in Psychiatry Network](http://www.nspn.org.uk/) from June 2017 to August 2018.
...
Isla remains the lead developer of scona 🍪, a Python package to perform `s`tructural `co`variance `n`etwork `a`nalysis of the human brain.
